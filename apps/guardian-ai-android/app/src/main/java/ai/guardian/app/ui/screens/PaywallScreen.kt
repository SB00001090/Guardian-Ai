...
import ai.guardian.app.ui.theme.NeonMagenta
...
fun PaywallScreen(
    ...
    Column(
        ...
        if (trialManager.isTrialActive()) {
            ...
            Text("試用期內可完整使用已解鎖功能", style = MaterialTheme.typography.bodyMedium)
        } else {
            Text("試用已結束", color = NeonMagenta, fontWeight = FontWeight.Bold)
            Text("一次性付費，永久使用 · 完整功能", style = MaterialTheme.typography.bodyLarge)
        }
